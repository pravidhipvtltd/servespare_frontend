...
const translations: Record<Language, Record<string, string>> = {
  ...
  ne: {
    ...
    "dashboard.low_stock": "कम स्टक वस्तुहRs",
    "dashboard.out_of_stock": "स्टक सकिएको",
    "dashboard.recent_sales": "हालको बिक्री",
    "dashboard.top_products": "शीर्ष उत्पादनहRs",
    "dashboard.system_status": "प्रणाली स्थिति",
    "dashboard.quick_actions": "द्रुत कार्यहRs",
    ...
    "parties.customers": "ग्राहकहRs",
    "parties.suppliers": "आपूर्तिकर्ताहRs",
    ...
    // Settings - Nepali
    "settings.title": "प्रणाली सेटिङहRs",
    "settings.company_info": "कम्पनी जानकारी",
    "settings.business_settings": "व्यापार सेटिङहRs",
    "settings.language": "भाषा",
    "settings.currency": "मुद्रा",
    "settings.timezone": "समय क्षेत्र",
    "settings.date_format": "मिति ढाँचा",
    "settings.tax_settings": "कर सेटिङहRs",
    "settings.notification_settings": "सूचना सेटिङहRs",
    "settings.security": "सुरक्षा सेटिङहRs",
    ...
    // CRM - Nepali
    "crm.contacts": "सम्पर्कहRs",
    "crm.deals": "सम्झौताहRs",
    "crm.activities": "गतिविधिहRs",
    "crm.lead": "लिड",
    "crm.customer": "ग्राहक",
  ...
  hi: {
    ...
    "settings.currency": "मुद्रा",
    "settings.timezone": "समय क्षेत्र",
    "settings.date_format": "तिथि प्राRsप",

...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'settings.language_description': 'Choose the language for the entire system',
  ...
  ne: {
    ...
    'dashboard.low_stock': 'कम स्टक वस्तुहरू',
    'dashboard.out_of_stock': 'स्टक सकिएको',
    'dashboard.recent_sales': 'हालको बिक्री',
    'dashboard.top_products': 'शीर्ष उत्पादनहरू',
    ...
    'parties.customers': 'ग्राहकहरू',
    'parties.suppliers': 'आपूर्तिकर्ताहरू',
    ...
    // Settings - Nepali
    'settings.title': 'प्रणाली सेटिङहरू',
    'settings.company_info': 'कम्पनी जानकारी',
    'settings.business_settings': 'व्यापार सेटिङहरू',
    'settings.language': 'भाषा',
    'settings.currency': 'मुद्रा',
    'settings.timezone': 'समय क्षेत्र',
    'settings.date_format': 'मिति ढाँचा',
    'settings.tax_settings': 'कर सेटिङहरू',
    'settings.notification_settings': 'सूचना सेटिङहरू',
    'settings.security': 'सुरक्षा सेटिङहरू',
    ...
    'message.error_occurred': 'एक त्रुटि देखा पर्यो। कृपया फेरि प्रयास गर्नुहोस्।',
    'message.no_data': 'कुनै डाटा उपलब्ध छैन',
    'message.loading_data': 'डाटा लोड हुँदै...',
    
    // CRM - Nepali
    'crm.contacts': 'सम्पर्कहरू',
    'crm.deals': 'सम्झौताहरू',
    'crm.activities': 'गतिविधिहरू',
    'crm.lead': 'लिड',
    'crm.customer': 'ग्राहक',
    ...
    'maintenance.four_wheeler': 'चार पाङ्ग्रे',

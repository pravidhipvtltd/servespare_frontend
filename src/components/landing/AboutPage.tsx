...
import { Users, Target, Heart, Award, TrendingUp, Globe2, Zap, Shield, Settings, Package } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8">
          {cards.map((card, index) => (
            ...
            >
              <div className={`w-20 h-20 bg-gradient-to-br ${card.color} rounded-2xl flex items-center justify-center text-white mb-6`}>
                {card.icon}
              </div>
              <h2 className="text-3xl font-bold mb-4">{t(card.titleKey)}</h2>
              <p className="text-xl text-gray-600 leading-relaxed">{t(card.descKey)}</p>
            </motion.div>
          ))}
        </div>
      </div>
...
const Values: React.FC = () => {
  ...
  const values = [
    { icon: <Zap />, titleKey: 'about.values.innovation', descKey: 'about.values.innovation.desc' },
    { icon: <Users />, titleKey: 'about.values.customer', descKey: 'about.values.customer.desc' },
    { icon: <Shield />, titleKey: 'about.values.reliability', descKey: 'about.values.reliability.desc' },
    { icon: <Heart />, titleKey: 'about.values.local', descKey: 'about.values.local.desc' },
    { icon: <Globe2 />, titleKey: 'about.values.scalability', descKey: 'about.values.scalability.desc' },
    { icon: <TrendingUp />, titleKey: 'about.values.efficiency', descKey: 'about.values.efficiency.desc' },
  ];

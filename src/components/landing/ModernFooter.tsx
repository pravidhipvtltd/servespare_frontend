...
// Blog Section
const BlogSection: React.FC<{ onNavigate: (page: PageType) => void }> = ({
  onNavigate,
}) => {
  const { t, language } = useLandingLanguage();
  ...
  const blogPosts = [
    {
      title:
        language === "en"
          ? "Revolutionizing Auto Parts Operations: The Power of Automation"
          : "अटो पार्ट्स सञ्चालनमा क्रान्ति: स्वचालनको शक्ति",
      date:
        language === "en"
          ? "Published on Nov 22, 2024"
          : "नोभेम्बर २२, २०२४ मा प्रकाशित",
      image:
    ...
    },
    {
      title:
        language === "en"
          ? "New Inventory Management Systems: Enhance Guest Satisfaction"
          : "नयाँ सूची व्यवस्थापन प्रणाली: अतिथि सन्तुष्टि बढाउनुहोस्",
      date:
        language === "en"
          ? "Published on Nov 22, 2024"
          : "नोभेम्बर २२, २०२४ मा प्रकाशित",
    ...
    },
    {
      title:
        language === "en"
          ? "From Manual Chaos to Digital Order: Why Every Business Needs Auto Parts Software"
          : "म्यानुअल अराजकता देखि डिजिटल व्यवस्था: किन हरेक व्यवसायलाई अटो पार्ट्स सफ्टवेयर चाहिन्छ",
      date:
        language === "en"
          ? "Published on Nov 22, 2024"
          : "नोभेम्बर २२, २०२४ मा प्रकाशित",
        ...
        <div className="grid md:grid-cols-4 gap-8 items-start">
          ...
          {blogPosts.map((post, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="font-bold mb-2 line-clamp-2 h-12">
                  {post.title}
                </h3>
...
const MobileAppSection: React.FC<{
...
}> = ({ onNavigate, setContactModalOpen }) => {
  ...
  return (
    <section
      ref={ref}
      className="py-20 bg-gradient-to-br from-indigo-50 via-purple-50 to-indigo-100 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-white/80 text-sm">
            <p>
              © {new Date().getFullYear()} SERVE SPARES. DEVELOPED IN
              PARTNERSHIP WITH{" "}
              <span className="text-white font-bold">PRAVIDHI</span>
            </p>
          </div>
        </div>
      </div>

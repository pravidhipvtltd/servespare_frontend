...
export const OrderCreationPanel: React.FC = () => {
    ...
    if (partySearchQuery.trim()) {
      ...
      const partyType =
        formData.type === "purchase"
          ...
          : ["customer"];
      setFilteredParties(
        parties.filter((p) => partyType.includes(p.type)).slice(0, 10)
      );
    }
  ...
  const handleAddItem = (item: InventoryItem) => {
    ...
    if (existingItem) {
      popup.showError("Item already added to order!", "Duplicate Item");
      return;
    }
  ...
  const handleSaveOrder = () => {
    if (!formData.partyId) {
      popup.showError("Please select a party!", "Validation Error");
      return;
    }
    ...
    if (!formData.expectedDeliveryDate) {
      popup.showError("Please set expected delivery date!", "Validation Error");
      return;
    }

    const storageKey =
      formData.type === "purchase" ? "purchaseOrders" : "salesOrders";
    const allOrders = getFromStorage(storageKey, []);

    const orderNumber = `${
      formData.type === "purchase" ? "PO" : "SO"
    ...
    popup.showSuccess(
      `Order ${orderNumber} has been created successfully! Your ${formData.type} order is now pending.`,
      "Order Created"
    );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-slate-300 mb-4">
                    Order stock from suppliers, distributors, or manufacturers
                  </p>
                </div>
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-slate-300 mb-4">
                    Create customer orders for parts and accessories
                  </p>
                </div>
                <div className="space-y-2 text-sm text-slate-400">
                  <div className="flex items-center gap-2">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-slate-400">
                  Choose the{" "}
                  {formData.type === "purchase" ? "supplier" : "customer"} for
                  this order
                </p>
              </div>
              <button
            ...
            <div className="relative mb-6">
              ...
              <input
                ...
                placeholder={`Search ${
                  formData.type === "purchase" ? "suppliers" : "customers"
                }...`}
              ...
              {filteredParties.length === 0 ? (
                <div className="text-center py-12 text-slate-400">
                  ...
                  <p className="text-sm mt-2">
                    Add parties from the Parties panel
                  </p>
                </div>
              ) : (
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-6">
              ...
              {formData.items.length === 0 ? (
                <div className="text-center py-12 text-slate-400">
                  ...
                  <p className="text-sm mt-2">
                    Search and add items to your order
                  </p>
                </div>
              ) : (
                ...
                <div className="mt-6 pt-6 border-t border-slate-600">
                  <div className="flex justify-between text-lg">
                    ...
                    <span className="text-white font-bold">
                      NPR {formData.subtotal.toFixed(2)}
                    </span>
                  </div>
                </div>
              )}
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-slate-400">
                  Add delivery date, discount, and notes
                </p>
              </div>
              <button
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold capitalize">
                      {formData.paymentTerms.replace("_", " ")}
                    </p>
                  </div>
                </div>
              </div>

        ...
        {paymentComplete ? (
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Your package has been upgraded to <span className="font-bold capitalize">{targetPackage}</span>
            </p>
            ...
            <div className="p-6">
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-4 mb-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-bold text-indigo-600 capitalize">{targetPackage}</span>
                </div>
                ...
                <p className="text-xs text-gray-500 text-right mt-1">per month</p>
              </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="font-medium text-gray-900 text-sm">eSewa</div>
                  ...
                  >
                    <div className="text-center">
                      <div className="text-2xl mb-1">📱</div>
                      <div className="font-medium text-gray-900 text-sm">FonePay</div>
              ...
              <div className="space-y-4 mb-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    {paymentMethod === 'esewa' ? 'eSewa ID / Mobile Number' : 'Mobile Number'}
                  </label>
                  <input
                    type="text"
                    value={paymentDetails.accountId}
                    onChange={(e) => setPaymentDetails({ ...paymentDetails, accountId: e.target.value })}
                    placeholder={paymentMethod === 'esewa' ? '98XXXXXXXX or eSewa ID' : '+977-XXXXXXXXXX'}
                    disabled={processing}
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  disabled={processing || !paymentDetails.accountId || !paymentDetails.pin}
                  className={`flex-1 py-3 rounded-lg text-white font-medium flex items-center justify-center ${
                    processing || !paymentDetails.accountId || !paymentDetails.pin
